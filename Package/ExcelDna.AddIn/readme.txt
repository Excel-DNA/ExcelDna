...
* Get IntelliSense and validation in your .dna files install the NuGet package ExcelDna.XmlSchemas
  > install-package ExcelDna.XmlSchemas
  Other alternatives documented here: https://github.com/Excel-DNA/ExcelDna/tree/master/Distribution/XmlSchemas/
