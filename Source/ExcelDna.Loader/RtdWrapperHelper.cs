...
namespace ExcelDna.Loader
{
    unsafe class RtdWrapperHelper
    {
        ...
        public RtdWrapperHelper(string progId, object rtdWrapperOptions)
        {
            ...
            int size = Marshal.SizeOf<XlOper12>();
            int stringSize = Marshal.SizeOf<XlString12>() + ((XlString12.MaxLength - 1) /* 1 char is in Data[1] */ * 2 /* 2 bytes per char */);
            ...
            _emptyStringXloper12->pstrValue = (XlString12*)Marshal.AllocCoTaskMem(Marshal.SizeOf<XlString12>());
