    ...
    public class PackExcelAddInN : AbstractTask
    {
        ...
        public override bool Execute()
        {
            try
            {
                ...
                int result = ExcelDna.PackedResources.ExcelDnaPack.PackN(OutputPackedXllFileName, RunMultithreaded, useManagedResourceResolver, _log);
                if (result != 0)
