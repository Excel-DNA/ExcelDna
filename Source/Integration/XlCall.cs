...
namespace ExcelDna.Integration
{
	public class XlCall
	{
		...
		*/
		...
		public static readonly int xlcVbaReset = (324 | xlCommand);
		public static readonly int xlcOptionsChart = (325 | xlCommand);
		public static readonly int xlcStart = (326 | xlCommand);
		public static readonly int xlcVbaEnd = (327 | xlCommand);
		...
		public static readonly int xlcVbaReferences = (331 | xlCommand);
		public static readonly int xlcVbaStepInto = (332 | xlCommand);
		public static readonly int xlcVbaStepOver = (333 | xlCommand);
		public static readonly int xlcVbaToggleBreakpoint = (334 | xlCommand);
		public static readonly int xlcVbaClearBreakpoints = (335 | xlCommand);
		...
		public static readonly int xlcVbaObjectBrowser = (345 | xlCommand);
		public static readonly int xlcVbaDebugWindow = (346 | xlCommand);
		public static readonly int xlcVbaAddWatch = (347 | xlCommand);
		public static readonly int xlcVbaEditWatch = (348 | xlCommand);
		public static readonly int xlcVbaInstantWatch = (349 | xlCommand);
		...
		private static extern unsafe int Excel4v(int xlfn,
			IntPtr /* XlOper* */ pOperRes,
			int count,
			IntPtr /* XlOper** */ ppOpers);

		// THROWS: XlCallException if anything goes wrong.
		public unsafe static object Excel(int xlFunction, params object[] parameters )
		{
			object result;
