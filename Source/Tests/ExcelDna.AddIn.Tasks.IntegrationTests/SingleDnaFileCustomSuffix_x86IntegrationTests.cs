...
namespace ExcelDna.AddIn.Tasks.IntegrationTests
{
    ...
    public class SingleDnaFileCustomSuffix_x86IntegrationTests : IntegrationTestBase
    {
        ...
        public void A_project_with_a_specific_dna_file_for_32_bit_using_custom_x86_suffix_copies_source_file_to_output_and_copies_corresponding_xll_files()
        {
            ...
            MsBuild(projectBasePath + "SingleDnaFileCustomSuffix_x86.csproj /p:ExcelDna32BitAddInSuffix=-x86 /p:ExcelDna64BitAddInSuffix=-x64 /t:Build /p:Configuration=Release /p:ExcelDnaPublishPath=publish /v:m " + MsBuildParam("OutputPath", @"bin\Release\"));
