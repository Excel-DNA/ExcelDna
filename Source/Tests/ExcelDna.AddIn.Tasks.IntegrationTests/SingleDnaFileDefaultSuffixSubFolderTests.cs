...
namespace ExcelDna.AddIn.Tasks.IntegrationTests
{
    ...
    public class SingleDnaFileDefaultSuffixSubFolderTests : IntegrationTestBase
    {
        ...
        public void A_project_with_a_single_dna_file_in_a_subfolder_using_default_suffix_copies_source_dna_to_32_and_64_bit_variants_and_copies_corresponding_xll_files_keeping_folder_structure()
        {
            ...
            AssertOutput(projectOutDir + @"MySubFolder\", "*.xll", "MyLibrary-AddIn.xll", "MyLibrary-AddIn-packed.xll", "MyLibrary-AddIn64.xll", "MyLibrary-AddIn64-packed.xll");
            AssertOutput(projectOutDir + @"MySubFolder\", "*.xll.config", "MyLibrary-AddIn.xll.config", "MyLibrary-AddIn-packed.xll.config", "MyLibrary-AddIn64.xll.config", "MyLibrary-AddIn64-packed.xll.config");
            ...
            AssertIdentical(projectBasePath + "App.config", projectOutDir + @"MySubFolder\MyLibrary-AddIn-packed.xll.config");

            AssertIdentical(projectBasePath + "App.config", projectOutDir + @"MySubFolder\MyLibrary-AddIn64.xll.config");
            AssertIdentical(projectBasePath + "App.config", projectOutDir + @"MySubFolder\MyLibrary-AddIn64-packed.xll.config");
        }
    }
}
