...
namespace ExcelDna.AddIn.Tasks.IntegrationTests
{
    ...
    public class ProjectWithNameEndingIn64IntegrationTests : IntegrationTestBase
    {
        ...
        public void A_project_with_name_ending_in_64_and_dna_name_ending_in_64_copies_source_dna_to_32_and_64_bit_variants_and_copies_corresponding_xll_files()
        {
            ...
            AssertOutput(projectOutDir, "*.xll", "ProjectWithNameEndingIn64-AddIn.xll", "ProjectWithNameEndingIn64-AddIn-packed.xll", "ProjectWithNameEndingIn64-AddIn64.xll", "ProjectWithNameEndingIn64-AddIn64-packed.xll");
            AssertOutput(projectOutDir, "*.xll.config", "ProjectWithNameEndingIn64-AddIn.xll.config", "ProjectWithNameEndingIn64-AddIn-packed.xll.config", "ProjectWithNameEndingIn64-AddIn64.xll.config", "ProjectWithNameEndingIn64-AddIn64-packed.xll.config");
            ...
            AssertIdentical(projectBasePath + "App.config", projectOutDir + "ProjectWithNameEndingIn64-AddIn-packed.xll.config");

            AssertIdentical(projectBasePath + "App.config", projectOutDir + "ProjectWithNameEndingIn64-AddIn64.xll.config");
            AssertIdentical(projectBasePath + "App.config", projectOutDir + "ProjectWithNameEndingIn64-AddIn64-packed.xll.config");
        }
    }
}
